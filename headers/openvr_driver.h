...
static const char *const k_InterfaceVersions[] =
	{
		...
		// IClientTrackedDeviceProvider_Version, //  TODO CHANGED
		nullptr};
...
{
	Clear();
	if (!VRServerDriverHost() || !VRSettings() || !VRProperties() || !VRDriverLog() || !VRDriverManager() || !VRResources())
...
{
	Clear();
	if (!VRCompositorDriverHost() || !VRSettings() || !VRProperties() || !VRDriverLog() || !VRDriverManager() || !VRResources())
		return VRInitError_Init_InterfaceNotFound;
	return VRInitError_None;
}
